...
import { C, BgTexture, NavRow, screenWrap, inputStyle, EyeIcon } from './welcomeUtils'
      ...
      <div style={{ ...screenWrap, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke={C.forest} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div style={screenWrap}>
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '0 28px 48px', display: 'flex', flexDirection: 'column', minHeight: 'calc(100vh - 110px)' }}>
        ...
        <div style={{ padding: '44px 0 36px', opacity: 0, animation: 'fadeUp 0.5s ease 0.12s forwards' }}>
          <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '30px', fontWeight: 500, color: C.ink, lineHeight: 1.2, marginBottom: '8px' }}>
            Welcome back.
          </div>
        ...
        <button
          ...
          style={{
            ...
            background: canSubmit ? C.forest : C.linen,
            color: canSubmit ? 'white' : C.driftwood,
          ...
          onMouseDown={e => canSubmit && !loading && (e.currentTarget.style.background = C.forestDk)}
          onMouseUp={e => canSubmit && !loading && (e.currentTarget.style.background = C.forest)}
          onTouchStart={e => canSubmit && !loading && (e.currentTarget.style.background = C.forestDk)}
          onTouchEnd={e => canSubmit && !loading && (e.currentTarget.style.background = C.forest)}
        >
          {loading ? (
        ...
        <div style={{ textAlign: 'center', marginTop: '8px', opacity: 0, animation: 'fadeUp 0.5s ease 0.33s forwards' }}>
          <button
            ...
            style={{
              ...
              fontFamily: "'Jost', sans-serif", fontSize: '13px', fontWeight: 300, color: C.driftwood,
        ...
        {forgotOpen && (
          <div style={{
            background: 'white', border: `1px solid ${C.linen}`,
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <input
                  ...
                  style={{
                    ...
                    fontFamily: "'Jost', sans-serif", fontSize: '14px', fontWeight: 300, color: C.ink,
                ...
                <button
                  ...
                  onMouseDown={e => e.currentTarget.style.background = C.forestDk}
                  onMouseUp={e => e.currentTarget.style.background = C.forest}
                >
                  Send
                </button>
              </div>
            ) : (
              <div style={{ fontSize: '12px', color: C.forest, fontWeight: 300 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '12.5px', color: C.driftwood, fontWeight: 300 }}>
            New to Roux?{' '}
            <button
              onClick={() => navigate('/get-started')}
              style={{
                background: 'none', border: 'none', cursor: 'pointer',
                fontFamily: "'Jost', sans-serif", fontSize: '12.5px', fontWeight: 400, color: C.forest,
