...
const SCREENS = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke={color.sage} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ width: 32, height: 32 }}>
        <line x1="9" x2="21" y1="6" y2="6"/>
        <line x1="9" x2="21" y1="12" y2="12"/>
        <line x1="9" x2="21" y1="18" y2="18"/>
        <circle cx="4" cy="6" r="1.3" fill={color.sage} stroke="none"/>
        <circle cx="4" cy="12" r="1.3" fill={color.sage} stroke="none"/>
        <circle cx="4" cy="18" r="1.3" fill={color.sage} stroke="none"/>
      </svg>
    ),
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ animation: 'fadeUp 0.4s ease both' }} key={step}>
          ...
          <div style={{ fontSize: '16px', color: color.inkSoft, lineHeight: 1.7, maxWidth: '300px', fontWeight: 400 }}>
            {screen.body}
          </div>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '8px', marginTop: '16px' }}>
          {SCREENS.map((_, i) => (
            <div key={i} style={{
              ...
              background: i === step ? color.forest : color.rule,
